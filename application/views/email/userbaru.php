					...
					<table border="0" width="600" cellpadding="0" cellspacing="0">
						<tr>
							<td style="color:#333333 !important; font-size:20px; font-family: Arial, Verdana, sans-serif; padding-left:10px;" height="40">
								<h3 style="font-weight:normal; margin: 20px 0;">Ada User Baru Tuh</h3>
								<p style="font-size:12px; line-height:18px;">
									Hai <?=$namalengkap?>,
								</p>
                                <p style="font-size:12px; line-height:18px;">
									Eh, cek daftar user deh. Ada temen se-angkatan kamu daftar tuh namanya <?=$namauser?>. Aktifin ya kalo bener temen kamu.
								</p>
                                <p style="font-size:12px; line-height:18px;">
									Terima Kasih.
								</p>
