		...
		<tr>
			<td align="center">
				<center>
					<table border="0" width="600" cellpadding="0" cellspacing="0">
						<tr>
							<td style="color:#333333 !important; font-size:14px; font-family: Arial, Verdana, sans-serif; padding-left:10px;">
								<h3 style="font-weight:normal; margin: 20px 0; font-size:20px;"><?=$judul?></h3>
                                <div style="border-bottom: solid 1px #ebebeb;"></div>
                                <p>
                                    <b>Tanggal:</b> <?=$this->rpl->tanggalLDMYHIS($row->date)?><br/>
                                    <b>Pengirim:</b> <?=$row->namalengkap?><br/>
                                </p>
                                <div style="border-bottom: solid 1px #ebebeb;"></div>
								<?=$row->isi?>
							</td>
						...
						<tr>
							<td style="color:#ffffff !important; font-size:20px; font-family: Arial, Verdana, sans-serif; padding-left:10px;" height="40">
								<center>
									...
									<br />
									<a href="<?=base_url('auth/login')?>" style="color: #fff;">Masuk</a>
								</p>
								</center>
							</td>
						</tr>
